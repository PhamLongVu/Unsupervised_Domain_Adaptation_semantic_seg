...
log_level = 'INFO'
load_from = '/kaggle/working/Unsupervised_Domain_Adaptation_semantic_seg/seg/iter_2000.pth'
resume_from = '/kaggle/working/Unsupervised_Domain_Adaptation_semantic_seg/seg/iter_2000.pth'
workflow = [('train', 1)]
cudnn_benchmark = True
norm_cfg = dict(type='BN', requires_grad=True)
find_unused_parameters = True
checkpoint = '/kaggle/working/Unsupervised_Domain_Adaptation_semantic_seg/seg/iter_2000.pth'
model = dict(
    type='EncoderDecoder',
    ...
    train_cfg=dict(
        work_dir='work_dirs/local-basic/240926_0452_anyName_01621',
        log_config=dict(
            interval=50,
            img_interval=200,
            hooks=[dict(type='TextLoggerHook', by_epoch=False)])),
...
gpu_ids = range(0, 1)
work_dir = 'work_dirs/local-basic/240926_0452_anyName_01621'
git_rev = '0da197d0c75869aa64473666fabb5012a7ef1493'
